...
.PHONY: all build install test coverage deps release bench test-int lint gen centos6 centos7 wheezy precise alpine3 arch
...
test-int: centos7 centos6 wheezy precise alpine3 arch
